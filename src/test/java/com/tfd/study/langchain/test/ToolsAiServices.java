...
public class ToolsAiServices<T> extends AiServices<T> {

    private static final int MAX_SEQUENTIAL_TOOL_EXECUTIONS = 10;

    ToolsAiServices(AiServiceContext context) {
        super(context);
    }
    ...
    public AiServices<T> tools(List<Object> objectsWithTools) {
        ...
        QwenToolsChatModel toolsChatModel = (QwenToolsChatModel) context.chatModel;
        for (Object objectWithTool : objectsWithTools) {
            for (Method method : objectWithTool.getClass().getDeclaredMethods()) {
                if (method.isAnnotationPresent(Tool.class)) {
                    ...
                    toolsChatModel.addSpecificationClass(toolSpecification, objectWithTool.getClass());
                }
            }
        }
